...
class AddCloudRequest(Model):
    ...
    def provider(self, provider):
        ...
        :type provider: str
        """
        allowed_values = ["alibaba", "amazon", "azure", "digitalocean", "docker", "equinix", "google", "kvm", "kubevirt", "kubernetes", "linode", "lxd", "onapp", "openstack", "openshift", "other", "rackspace", "vsphere", "vultr"]  # noqa: E501
